...
T=6*rhi;                                      %the period of the sinusoidal roughness
...
sinusoidal_x1=[x_min:rhi/10:x_max]';
sinusoidal_y1=0.5*A*(sin((2*pi*sinusoidal_x1)/T)-1)+y_min;
...
sinusoidal_x2=[x_min:rhi/10:x_max]';
sinusoidal_y2=0.5*A*(sin((2*pi*sinusoidal_x2)/T)+1)+y_max;
